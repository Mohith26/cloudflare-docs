...
- Production branch builds create a new [version](/workers/configuration/versions-and-deployments/) under Version History. If the build is configured to deploy, that version is promoted to the Active Deployment.
