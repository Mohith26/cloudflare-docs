...
You can build this loop yourself on top of the [Agents SDK runtime](/agents/runtime/agents-api/), or use an opinionated harness like [Project Think](/agents/harnesses/think/), [Flue](/agents/harnesses/flue/), or [Pi](/agents/harnesses/pi/).
...
Use Flue when you want a TypeScript harness that can run locally and deploy generated agents and workflows onto Cloudflare Workers and Agents SDK Durable Objects.

Use Pi when you want Pi's coding-agent loop inside a custom Worker API and an Agents SDK Durable Object.
...
<LinkCard
	title="Flue"
	href="/agents/harnesses/flue/"
	description="A TypeScript agent harness that deploys generated agents and workflows onto Cloudflare Workers."
/>

<LinkCard
	title="Pi"
	href="/agents/harnesses/pi/"
	description="A minimal coding-agent harness that runs inside a custom Agents SDK Durable Object."
/>
