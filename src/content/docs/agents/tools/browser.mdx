...
Give your agents full access to [Browser Run](/browser-run/) tools to inspect pages, capture screenshots, scrape rendered content, and debug frontend issues. <InlineBadge preset="beta" />
