...
For lightweight JavaScript orchestration of MCP tools, use [Codemode](/agents/tools/mcp/protocol/codemode/). Codemode runs generated JavaScript in an isolated Worker sandbox and is optimized for typed tool composition. Sandbox is for full Linux execution environments.
