...
description: Build a document agent that uses Retrieval Augmented Generation with AI Search and durable execution for long-running document workflows.
sidebar:
  order: 6
---
