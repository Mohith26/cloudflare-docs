...
In `@cloudflare/sandbox@next`, streaming command output moves to the consolidated `exec()` process API. For more information, refer to [Migrate to Sandbox SDK next](/sandbox/guides/migrating-to-next/).
:::
