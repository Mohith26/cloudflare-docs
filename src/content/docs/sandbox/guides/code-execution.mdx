...
In `@cloudflare/sandbox@next`, Code Interpreter moves from the core SDK into a plugin. For more information, refer to [Migrate to Sandbox SDK next](/sandbox/guides/migrating-to-next/).
:::
