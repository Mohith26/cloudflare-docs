...
The `enableDefaultSession` option is removed in `@cloudflare/sandbox@next`. Top-level operations run sessionlessly by default. For more information, refer to [Migrate to Sandbox SDK next](/sandbox/guides/migrating-to-next/).
:::
