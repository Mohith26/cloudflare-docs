...
HTTP and WebSocket transports are removed in `@cloudflare/sandbox@next`. Move existing projects to RPC before migrating. For more information, refer to [Migrate to Sandbox SDK next](/sandbox/guides/migrating-to-next/).
:::
